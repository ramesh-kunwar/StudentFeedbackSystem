...
const SemesterDetails = () => {
  ...
  const { data: semester, isLoading, error } = useGetSemesterDetailsQuery(id);
  ...
  return (
    <div className="bg-slate-50 pt-10 min-h-screen">
      <div className=" md:grid grid-cols-3 container  mx-auto max-w-6xl bg-white shadow rounded-xl  px-10 py-10">
        <div className="">
          <h1 className="mx-auto bg-white text-4xl font-bold -8">
            {semester?.data?.name}
          </h1>
          <h1 className="text-8xl  font-black text-orange-600">1.0</h1>
          <div className="  my-4">
